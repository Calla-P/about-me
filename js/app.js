...
if (answer5 === 'yes'|| answer5 === 'y'){
  ...
  alert('Absolutely and with confidence. You ARE correct and awesome!');
} else if (answer5 === 'no'|| answer5 ==='n'){
  console.log('said no');
  alert('That is not right, she picks those pineapples nicely. You are kind for playing regardless of being wrong. lol ');
} else {
  console.log(' invalid response.');
  alert('Bold statement but a y/n will get us where we need to go.');
}
